...
## XNOR TRAINING
#../darknet/darknet detector train obj.data cfg/yolov3-tiny_3l_xnor.cfg backup/yolov3-tiny_3l_xnor_last.weights -dont_show -mjpeg_port 8090 -map 
...
## XNOR TESTING
../darknet/darknet detector map ./obj.data ./cfg/yolov3-tiny_3l_xnor.cfg results/tiny_3l_xnor_20210330/yolov3-tiny_3l_xnor_best.weights
